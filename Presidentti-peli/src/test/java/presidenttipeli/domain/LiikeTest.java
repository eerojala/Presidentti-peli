...
public class LiikeTest {
    ...
    @Before
    public void setUp() {
        liike1 = new Liike("Tyyppi", "Liike1", 10000, 1000);
    ...
    public void compareToJarjestaaOikeinJosEriArvot() {
        liike2 = new Liike("Tyyppi", "Liike2", 9999, 1000);
        liikkeet.add(liike2);
        liikkeet.add(liike1);
    ...
    public void compareToJarjestaaOikeinJosSamatArvot() {
        liike2 = new Liike("Tyyppi", "Liike2", 10000, 1001);
        liikkeet.add(liike1);
        liikkeet.add(liike2);
        Collections.sort(liikkeet);
